# Architecture Decision Log -- Phase A

Part of the split `docs/DECISIONS.md` architecture decision log (ADR-0001 through ADR-0014). See `docs/DECISIONS.md` for the full index across all phases.

Historical reference only -- see docs/exec-plans/completed/PHASE_A_RESULT.md and docs/exec-plans/active/PHASE_A.md. Superseded by later phases; do not rewrite.
