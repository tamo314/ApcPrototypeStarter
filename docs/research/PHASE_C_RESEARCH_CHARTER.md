# Phase C — Routing identifiability research charter (HISTORICAL — `TERMINATED_CURRENT_CHARTER`)

Date: 2026-09-13. Version: charter-v1. **Terminal status: `TERMINATED_CURRENT_CHARTER`**
(ADR-0160, C-D001AA, 2026-09-13). This charter was never approved and never executed
experimentally; it was falsified/retracted entirely during pre-execution mathematical
review. It is preserved below unmodified as a historical artifact. Architecture:
`NOT_SELECTED` (permanently barred, never reached). First experiment: `NOT_DEFINED`
(never defined). Research execution: `NOT_AUTHORIZED` (never authorized, at any point).
Status reference: Audited by C-D001 (ADR-0150), C-D001R (ADR-0151), C-D001S (ADR-0152), C-D001T (ADR-0153), C-D001U (ADR-0154), C-D001V (ADR-0155), C-D001W (ADR-0156), C-D001X (ADR-0157), C-D001Y (ADR-0158), C-D001Z / ADR-0159 (`ROUTING_IDENTIFIABILITY_QUALIFIED_STOP`: Blind grounding proven to be an identifiability impossibility via indistinguishable symmetric worlds with $H(Z|\text{obs}) > 0$; grounded representations dominated by $B_{\text{det\_emb}}$ with 100% ceiling; Impossibility-Dominance Dilemma proves non-trivial residual learning space is empty; residual Charter candidate `H-C1-Residual` formally RETRACTED), and C-D001AA / ADR-0160 (`PHASE_C_CURRENT_CHARTER_FALSIFICATION_SUFFICIENT`: audits ADR-0150-0159 for falsification sufficiency, consolidates ADR retractions/supersessions, scopes the impossibility claim strictly to the examined representation classes, confirms no in-charter conclusion-changing task remains, and formally terminates this charter). This is a negative conclusion about this charter's current H-C1 formulation, not a claim that APC in general is impossible.
...
- **C-D001T Semantic-Descriptor Boundary & Repair Audit (2026-09-13):** [Semantic-descriptor boundary audit](../phase_c/PHASE_C_C_D001T_SEMANTIC_DESCRIPTOR_BOUNDARY_AUDIT.md) and [ADR-0153](../DECISIONS_PHASE_C.md#adr-0153-c-d001t-semantic-descriptor-boundary--impossibility-proof-repair-audit-qualifies-stop-to-routing_identifiability_qualified_stop-adr-0152-quantifier-retracted--restricted) specified formal language of permitted compositional descriptors and oracle leakage rules; repaired ADR-0151/ADR-0152 circular definitions using actual APC operations (BindOp, NeighborMaxOp); proved lawful descriptors equipped with general tie-break semantics separate adversarial worlds (Theorem 3); retracted and restricted ADR-0152's quantifier-complete claim; reclassified stop to `ROUTING_IDENTIFIABILITY_QUALIFIED_STOP`. Research execution remains `NOT_AUTHORIZED`.
- **C-D001U Semantic Descriptor Oracle-Equivalence & Minimality Audit (2026-09-13):** [Semantic descriptor oracle-equivalence audit](../phase_c/PHASE_C_C_D001U_SEMANTIC_DESCRIPTOR_ORACLE_EQUIVALENCE_AND_MINIMALITY_AUDIT.md) and [ADR-0154](../DECISIONS_PHASE_C.md#adr-0154-c-d001u-semantic-descriptor-oracle-equivalence--minimality-audit-reconfirms-routing_identifiability_stop) formalized deterministic $z$-computable reduction mapping $(x, D) \mapsto z^*$; determined that candidate-selection tie-break procedures are oracle-equivalent supervision under Charter H-C1; constructed minimality counterexamples proving lawful non-oracle descriptors cannot separate World A/B on duplicate tokens; rejected Training Information Contract v1.1; definitively reconfirmed `ROUTING_IDENTIFIABILITY_STOP` prior to architecture derivation. Research execution remains `NOT_AUTHORIZED`.
- **C-D001V Non-Circular Oracle-Equivalence Falsification Experiment (2026-09-13):** [Oracle-equivalence falsification experiment](../phase_c/PHASE_C_C_D001V_ORACLE_EQUIVALENCE_FALSIFICATION_EXPERIMENT.md) and [ADR-0155](../DECISIONS_PHASE_C.md#adr-0155-c-d001v-non-circular-oracle-equivalence-falsification-experiment-retracts-adr-0154-universal-stop-to-routing_identifiability_qualified_stop) pre-registered 5-dimensional non-circular oracle-supervision criteria calibrated against positive/negative controls; proved `FIRST/LAST`, `LEFTMOST/RIGHTMOST`, and procedural composition are strictly non-oracle (0/5 oracle score); proved they separate World A/B on collision tokens; mathematically falsified and retracted ADR-0154's universal STOP; reclassified stoppage to `ROUTING_IDENTIFIABILITY_QUALIFIED_STOP`. Research execution remains `NOT_AUTHORIZED`.
- **C-D001W Adversarial Mixed-Control Validation (2026-09-13):** [Adversarial mixed-control validation](../phase_c/PHASE_C_C_D001W_ADVERSARIAL_MIXED_CONTROL_VALIDATION.md) and [ADR-0156](../DECISIONS_PHASE_C.md#adr-0156-c-d001w-adversarial-mixed-control-validation-confirms-adr-0155-05-non-oracle-determination-and-derives-training-information-contract-v11--deterministic-baseline) evaluated adversarial mixed controls (bytecode interpreter, encrypted lookups, metadata, static routing programs, support selectors) under ADR-0155's 5-dimensional criterion; proved representation invariance, monotonicity, and leave-one-out necessity of all 5 dimensions; confirmed fail-closed optimality of the disjunctive rejection rule ($\theta=1$); upheld the 0/5 non-oracle classification of FIRST/LAST; and derived candidate Training Information Contract v1.1 and descriptor-only deterministic baseline requirements. Research execution remains `NOT_AUTHORIZED`.
- **C-D001X Contract-v1.1 Hypothesis-Preservation & Deterministic-Baseline Dominance Audit (2026-09-13):** [Audit](../phase_c/PHASE_C_C_D001X_CONTRACT_V1_1_HYPOTHESIS_PRESERVATION_AND_DETERMINISTIC_BASELINE_DOMINANCE_AUDIT.md) and [ADR-0157](../DECISIONS_PHASE_C.md#adr-0157-c-d001x-contract-v11-hypothesis-preservation--deterministic-baseline-dominance-audit-finds-h-c1-estimand-trivialized-by-unlearned-deterministic-reduction) proved the descriptor-only deterministic baseline $B_{\text{det}}$ satisfies 100% of routing/execution floors with $H(Z\mid X,D)=0.0$ and 0 learned parameters, trivializing H-C1's estimand under Contract v1.1 (`H_C1_TRIVIALIZED_ESTIMAND_ALTERED_BY_CONTRACT_V1_1`). Research execution remains `NOT_AUTHORIZED`.
- **C-D001Y Embedding-Aware Deterministic Baseline Closure Audit (2026-09-13):** [Audit](../phase_c/PHASE_C_C_D001Y_EMBEDDING_AWARE_DETERMINISTIC_BASELINE_CLOSURE_AUDIT.md) and [ADR-0158](../DECISIONS_PHASE_C.md#adr-0158-c-d001y-embedding-aware-deterministic-baseline-closure-audit-finds-continuous-neural-grounding-dominated-by-b_det_emb-under-invertible-representations) proved the embedding-aware deterministic baseline $B_{\text{det\_emb}}$ achieves a 100% ceiling with 0 learned parameters under invertible representations, trivializing continuous neural grounding as a residual estimand (`CONTINUOUS_GROUNDING_DOMINATED_BY_B_DET_EMB_UNDER_INVERTIBLE_REPRESENTATIONS`). Research execution remains `NOT_AUTHORIZED`.
- **C-D001Z Blind Codebook Identifiability & Symmetry-Breaking Audit (2026-09-13):** [Audit](../phase_c/PHASE_C_C_D001Z_BLIND_CODEBOOK_IDENTIFIABILITY_AUDIT.md) and [ADR-0159](../DECISIONS_PHASE_C.md#adr-0159-c-d001z-blind-codebook-identifiability--symmetry-breaking-audit-proves-blind-grounding-impossible-and-retracts-residual-charter-candidate) proved blind grounding under codebook symmetry is an identifiability impossibility or deterministic-baseline dominance with no third regime (Impossibility-Dominance Dilemma), and formally retracted the residual Charter candidate `H-C1-Residual` (`BLIND_GROUNDING_IDENTIFIABILITY_IMPOSSIBILITY_PROVEN`). Research execution remains `NOT_AUTHORIZED`.
- **C-D001AA Falsification Sufficiency & Charter Termination Audit (2026-09-13):** [Audit](../phase_c/PHASE_C_C_D001AA_FALSIFICATION_SUFFICIENCY_AND_CHARTER_TERMINATION_AUDIT.md) and [ADR-0160](../DECISIONS_PHASE_C.md#adr-0160-c-d001aa-phase-c-falsification-sufficiency--charter-termination-audit-closes-the-current-charter-phase_c_current_charter_falsification_sufficient) audited ADR-0150-0159 for falsification sufficiency without proposing any new repair, architecture, or residual hypothesis; confirmed the current state, consolidated ADR retractions/supersessions, separated "this charter is falsified" from "APC in general is impossible," confirmed the relation-inventory deficit as an independent unremedied FAIL, found no in-charter conclusion-changing task remains, and terminated the charter (`PHASE_C_CURRENT_CHARTER_FALSIFICATION_SUFFICIENT`). **Phase C status: `TERMINATED_CURRENT_CHARTER`.** See the [termination evidence ledger](../results/PHASE_C_TERMINATION_EVIDENCE_LEDGER.md). Any future research question requires a separate, independently authorized charter and review.
